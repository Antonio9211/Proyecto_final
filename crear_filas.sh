...
other-config:max-rate=10000000 queues:1=@q1 queues:2=@q2 queues:3=@q3 -- --id=@q1 create queue other-config:max-rate=5000000 -- --id=@q2 create queue other-config:max-rate=3000000 -- --id=@q3 create queue other-config:max-rate=2500000      # Fila bajo bw
